...
export default function AuthInput({ 
    ...
    const baseInputClasses = "w-full pr-3 py-2 border-b outline-none bg-transparent text-[var(--foreground)] placeholder-neutral-400 dark:placeholder-gray-400";
    ...
    return (
        <div>
            {label && <label htmlFor={id} className="block text-sm font-medium mb-1 text-[var(--foreground)]">{label}</label>}
